...
Aburrá. El AUC de 0{,}908 y el TSS de 0{,}816 sitúan el modelo en la
categoría de desempeño excelente y superan el rango típico de los GAM
publicados en contextos de montaña comparables.
\citet{petschko2014} reportaron AUC variables por dominio litológico
en Austria empleando GAM sobre 15\,850\,km², con la mayoría de los
dominios en el intervalo 0{,}72--0{,}89;
\citet{brenning2008statistical} obtuvo resultados competitivos con GAM
en los Andes tropicales sudamericanos.
...
durante el entrenamiento. \citet{Roberts2017} demostraron que esta sobrestimación puede ser
sustancial en conjuntos con autocorrelación positiva alta, dependiendo
del alcance espacial de la dependencia entre observaciones. En consecuencia, el AUC = 0{,}908 debe
...
por bloques espaciales, separando los \textit{folds} por microcuencas o cuadrantes
...
\citet{merghadi2020} concluyeron en una revisión comprensiva que los
métodos de ensamble (RF, XGBoost) superan consistentemente a los
modelos estadísticos clásicos en AUC, siendo el algoritmo de bosques
aleatorios el de mejor desempeño promedio con mínimo ajuste de
hiperparámetros. Sin embargo, la ventaja
crítica del GAM en el contexto de la gestión del riesgo de desastres reside en la
...
tomadores de decisión, sin requerir herramientas como los
valores \textit{SHAP}. En entornos regulatorios donde los modelos deben ser
...
En cuanto a la no-linealidad de las variables morfométricas la función $s(\text{pendiente})$ exhibe el rasgo no lineal más
...
\citet{Vorpahl2012}, quienes aplicaron GAM en un bosque montano
tropical del Ecuador y encontraron que la pendiente exhibe una respuesta
no lineal con reducción de la probabilidad de falla a gradientes muy
pronunciados, consistente con el mecanismo de agotamiento. La revisión de \citet{reichenbach2018review} sobre
...
ignoran sobreestiman sistemáticamente la susceptibilidad en escarpes. En el Valle de Aburrá, donde las vertientes más pronunciadas
corresponden a afloramientos de gneis, anfibolitas y dunitas con escaso perfil de meteorización, la coherencia geomecánica
de este mecanismo es correcta: los movimientos en masa en saprolito se
concentran en pendientes moderadas a empinadas (20°--45°), mientras que
los escarpes son intrínsecamente estables a este tio de movimientos en masa (deslizamientos y flujos) por que han
...
La función $s(\text{elevación})$ señala el pico de susceptibilidad en el intervalo 1\,500--1\,900\,m y el
...
meteorización más potentes del Valle de Aburrá se desarrollan
preferentemente en ese rango altitudinal, donde la combinación de
temperatura, humedad y tiempo de exposición genera horizontes sobre los que se producen los deslizamientos
...
espesor de suelo y menor presión antrópica directa, lo que puede explicar la
reducción de susceptibilidad en ese rango.

La función $s(\text{aspecto})$ presenta la mayor susceptibilidad en orientaciones oeste-noroeste (225°--315°)
...
\citet{aristizabal2016shia} modelaron la dinámica de saturación del
suelo en cuencas andinas colombianas, evidenciando que la distribución
topográfica de la humedad antecedente —modulada en parte por la
orientación de ladera— es condición previa para la iniciación de
deslizamientos superficiales bajo tormentas intensas. En el contexto
colombiano, \citet{HerreraCoy2023} analizaron la susceptibilidad en
la cordillera Oriental y documentaron la heterogeneidad morfométrica
como factor diferenciador entre tipos de movimiento, lo que subraya
la pertinencia de incluir el aspecto en los modelos estadísticos. La
literatura señala que el efecto del aspecto es altamente dependiente
del contexto climático local y no admite generalización directa entre
regiones \citep{reichenbach2018review}.
...
habituales que descomponen el aspecto en componentes seno/coseno, los cuales suponen implícitamente una respuesta sinusoidal de período
...
La función $s(\text{TWI})$ emerge como el predictor dominante por amplio margen,
...
por \citet{Munoz2023heliyon} en los Andes ecuatorianos, donde los
índices de humedad topográfica figuran entre los predictores con mayor
peso explicativo de la susceptibilidad, y con \citet{moralesvelez2024},
quienes documentaron en la región andina colombiana que la variabilidad
de la humedad del suelo —gobernada en parte por la topografía— modula
la respuesta de los deslizamientos al forzamiento climático del ENOS. Desde una perspectiva física, la dominancia del TWI
...
Las funciones $s(\text{curvaturas planiforme y de perfil})$ señala valores mayores de susceptibilidad en zonas cóncavas (curvaturas negativas), lo que
...
favorece la falla del suelo durante eventos extremos
...
de como continuo lineal. Este resultado es consistente con la
...
El inventario construido en este trabajo puede ser el más completo disponible para el Valle de
Aburrá, pero comparte los sesgos introducidos por la disponibilidad de imágenes de satélite y la experiencia del interprete. \citet{steger2017} demostraron que
incluso inventarios sesgados producen modelos con AUC
...
humana, por ejemplo. \citet{Steger2021correlation} confirmaron que la correlación
estadística entre predictores morfométricos y deslizamientos puede
reflejar los efectos del proceso de recolección de datos más que la
susceptibilidad intrínseca del terreno, subrepresentando eventos en
áreas forestadas y de difícil acceso.
...
probabilidad de registro en ese rango. Diferenciar la
...
sobre subconjuntos del inventario estratificados.
...
homogeneidad disponible, mientras que la geología regional (1:10\,000)
y el uso del suelo presentan incertidumbres espaciales de varios
metros incompatibles con el píxel fino del modelo. \citet{reichenbach2018review} documentaron en una revisión de
565\,estudios que la morfometría topográfica es el grupo de variables
más frecuentemente empleado y que en la mayoría de ellos constituye
el principal componente explicativo del modelo, validando el enfoque
morfométrico como punto de partida autosuficiente.
...
simultáneamente la franja donde afloran los materiales más meteorizados
y la zona de mayor densidad constructiva. El TWI actúa como proxy estático de la propensión
...
morfométricas derivadas. \citet{chang2019scale} mostraron que las
